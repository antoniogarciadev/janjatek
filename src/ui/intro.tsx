...
export default function Intro() {
  return (
    <section className="reveal w-full h-screen bg-white z-50 absolute inset-0 flex flex-col md:flex-row items-center justify-center px-5 gap-10 md:gap-20 mx-auto ani-appear">
      <div className=" flex flex-col items-center md:items-start gap-4 ani-intro">
        ...
        <p className="text-(--color-purple-2) text-2xl text-center md:text-3xl md:tracking-wider">Da imaginação ao produto</p>
      </div>
